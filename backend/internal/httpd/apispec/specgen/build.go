...
var schemaNames = map[string]string{ //nolint:gosec // Public OpenAPI type names include reset-credit contracts; no credential value is stored here.
	...
	"ControllersSessionBriefResponse":                     "SessionBriefResponse",
	"ControllersSessionBriefFile":                         "SessionBriefFile",
	"ControllersSessionBriefCommit":                       "SessionBriefCommit", "ControllersSessionPRConflictFile": "SessionPRConflictFile",
...
func sessionOperations() []operation {
	return []operation{
		...
		{
			method: http.MethodGet, path: "/api/v1/sessions/{sessionId}/brief", id: "getSessionBrief", tag: "sessions",
			summary:    "Fetch the @mention brief for one session",
			pathParams: []any{controllers.SessionIDParam{}},
			resps: []respUnit{
				{http.StatusOK, controllers.SessionBriefResponse{}},
				{http.StatusNotFound, envelope.APIError{}},
				{http.StatusInternalServerError, envelope.APIError{}},
			},
		},
