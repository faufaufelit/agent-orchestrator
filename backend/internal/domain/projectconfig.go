...
type ProjectConfig struct {
	...
	// OrchestratorRulesFile is a repo-relative Markdown/text file whose
	// contents are appended to OrchestratorRules for orchestrator sessions.
	// It holds the long-lived part (persona, memory discipline, delegation
	// policy) that would bloat inline rules.
